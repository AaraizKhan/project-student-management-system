...
const randomIDnumber : number = Math.floor(1000 + Math.random() * 90000)
    ...
    [
        {
            ...
            validate: function (value){   // validate check user's input is valid or invalid
                if(value.trim()!== ""){
                    return true;
                }
...
const SubjectsFees: {[key: string]: number} = {
    "HTML":2000,
    "CSS": 3000,
    "Javascript": 3500,
    "Typescript":5000,
